...
export interface ApiMediaTagMediaTag extends Schema.CollectionType {
  collectionName: 'media_tags';
  info: {
    singularName: 'media-tag';
    pluralName: 'media-tags';
    displayName: 'mediaTag';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVideoVideo extends Schema.SingleType {
  ...
  attributes: {
    event: Attribute.Component<'components.gallery', true> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
